...
function instantiate() {
  ...
  `You stay silent and uncuff the smuggler and lead him below deck where you freeze him in Carbonite, and continue ${playerWeaknessQ3} the ${playerSillyAnimalQ4}s from earlier.`, 
  `You accept his offer and take his money before shoving him into an escape pod, take a(n) ${playerWeaknessQ3} break, eject it into the deep darkness of space, and leave him to fend for himself.`,'mandalorian');
  ...
  'You gently pick up the child and carry it back to the ship.',
  ...
  'You gently pick up the child and carry it back to the ship.', 'baby-yoda');
  ...
  'You distract the child with a small metal ball that it can play with and carry it up to the cockpit, where you buckle it into the seat beside yours.',
  
  'You fire a warning shot which scares the child and stops the destruction. You then throw the child into a holding cell. That child deserves a timeout.',
  ...
  'You hide in a dark alcove of the ship in order to catch the scavengers by surprise. You manage to kill all the scavengers that board your ship as well as the remainder that are on the scavenger ship. You take over the ship, but the child is angry and uses its force powers to lock the ship controls and sets a course to Cattooine.',
  ...
  'You entertain the henchmen’s offer and follow them to Yabba’s palace.', 'You quickly take out the henchmen and make your way to Yabba’s palace yourself. You want to do this on your terms.',
  ...
  'You turn down the offer. Yabba’s henchmen surround you and you are too outnumbered to take them out on your own. Luckily for you, the child understands what is happening and uses its force powers to slam half the henchmen against the wall while you take out the others. Once you take out all of the henchmen, you threaten Yabba, telling him you’ll kill him if he doesn’t give you the sum he offered for turning in the child.',
  
  'You think it over, then ask for double the sum that Yabba initially offers. After all, it is the child’s fault that you were stranded there. Yabba recoils at your request, but after some negotiation, offers you 75% of what you asked for. You take it and hand the child over. As you leave, the child throws a tantrum and begins destroying the palace with it’s force powers. You chuckle on your way out. Yabba and the rest of his henchmen are unable to subdue the child. As you walk away from the palace, you hear the doors open. You turn and see Yabba’s henchmen throw the child out of the palace. The child picks himself up and makes its way toward you. Looks like you’re back on babysitting duty.',
  
  'You turn down the offer. Yabba’s henchmen surround you and you are too outnumbered to take them out on your own. Luckily for you, the child understands what is happening and uses its force powers to slam half the henchmen against the wall while you take out the others. Once you take out all of the henchmen, you threaten Yabba, telling him you’ll kill him if he doesn’t give you the sum he offered for turning in the child.',
  
  '');
  new Strings('The repairs on your ship are now complete. As you’re preparing to take off, you receive a hologram message from an acquaintance, Seado Calrissian. He has come across some Meskar steel and though he has several parties interested in this rare metal, he decided he would give you a chance to win some from him. The catch? You have to beat him in a game of Tabacc. If you fail, he will not take anything of yours, but the Meskar will go to the highest bidder – which includes some of your rivals. You take him up on his offer.',
  
  'You see you have a losing hand. One of Seado’s friends comes to the table to speak with him. As Seado is distracted, you switch a card in your hand for one on the table. No one notices.',
  ...
  'You tell the smith that you want to make minor repairs to your armour and donate the rest to the foundlings.',
  
  'You fully replace your own armour. There’s always more Meskar out there for the foundlings and you need new armour to operate effectively.', 'You tell the smith that you want to make minor repairs to your armour and donate the rest to the foundlings.',
  ...
  'You tell him that the cargo was destroyed while fighting the reptilian. “How unfortunate,” the dealer replies. As you leave, several guards surround you. They know you have the cargo and escort you to a meeting with the Empire.',
  
  'You tell him that the cargo was destroyed while fighting the reptilian. “How unfortunate,” the dealer replies. As you leave, several guards surround you. They know you have the cargo and escort you to a meeting with the Empire.',
  
  '');
  new Strings('You and your escort enter the room where the representatives from the Empire are waiting. An old general sits at a table and a young scientists stands next to you. The guards that escorted you continue to surround you, their guns at the ready. The general asks to see the cargo. You refuse, telling him you need to see your reward first. Laughing, the general orders a soldier to pull a large crate over on a cart. The soldier opens to the lid to the crate to reveal more Meskar than you’ve ever seen at once before. There is more than enough to make new armour for your entire Tantalorian clan. You open the bag and take the child out. He looks at you with large, unblinking, sad eyes.',
  
  'With resolve, you hand the child over and take the Meskar. As you leave the room, you hear the child cry out. Once you’ve left the building, you hear loud crashes, blasters go off, shouting, then silence. It sounds like the Empire got more than they bargained for. You smirk as you turn to head towards your ship. Before you’re able to take another step, you feel a small tug on your leg. Looks like you’re stuck babysitting yet again.',
